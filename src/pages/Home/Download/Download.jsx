                    ...
                    <div className='lg:w-1/2 mb-4 lg:mb-0 container lg:text-start py-8 text-center'>
                        ...
                        <div className='flex mt-4 lg:justify-start  justify-center'>
                            <a href="" download className='mr-4 '>
                                <img src="https://cdn-icons-png.flaticon.com/128/300/300218.png" alt="Image 1" className='rounded-lg'/>
                            </a>
                            <img src="https://cdn-icons-png.flaticon.com/128/731/731985.png" alt="Image 2"  className='rounded-lg'/>
                        </div>
                    </div>
